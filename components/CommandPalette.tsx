...
const COMMANDS: NavCommand[] = [
  ...
  { id: 'docs-skills', title: 'Docs: Skills Reference', category: 'Docs', url: '/docs/skills' },
  { id: 'docs-vault', title: 'Docs: Secrets & Credential Security', category: 'Docs', url: '/docs/vault' },
