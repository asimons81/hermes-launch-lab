  ...
  return (
    <article>
      ...
      <div className="card" style={{ marginTop: 24 }}>
        ...
        <h2 style={{ marginTop: 24 }}>2. Payment &amp; Booking</h2>
        <p style={{ color: 'var(--muted)' }}>
        ...
        <h2 style={{ marginTop: 24 }}>4. Confidentiality</h2>
        <p style={{ color: 'var(--muted)' }}>
        ...
        <h2 style={{ marginTop: 24 }}>7. Limitation of Liability</h2>
        <p style={{ color: 'var(--muted)' }}>
        ...
        <h2 style={{ marginTop: 24 }}>9. Governing Law</h2>
        <p style={{ color: 'var(--muted)' }}>
        ...
        <h2 style={{ marginTop: 24 }}>10. Independent Service</h2>
