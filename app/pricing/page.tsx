    ...
    <>
      ...
      <main id="main-content" tabIndex={-1} className="shell page-shell" style={{ paddingTop: 40, paddingBottom: 64 }}>
        ...
        <p className="page-intro">
          Launch and Custom sessions leave you with working software; Strategy ends with a written action plan. Pick the depth of help you need — no upsell maze, no vague subscriptions.
        </p>
        ...
        <section style={{ marginTop: 56 }}>
          ...
          <h2 style={{ letterSpacing: '-0.04em', fontSize: 28, marginTop: 4, marginBottom: 8 }}>
            Estimate what a configured agent could save you
          </h2>
          <p style={{ color: 'var(--muted)', fontSize: 16 }}>
            Adjust the sliders below to see an illustrative estimate of monthly time savings and annual engineering value.
          </p>
          <RoiCalculator />
        </section>

        <p className="notice" style={{ marginTop: 40, color: 'var(--muted)', fontSize: 14 }}>
          Checkout processed via Stripe. Independent service — not affiliated with Nous Research.
        </p>
      </main>
      <SiteFooter />
    </>
