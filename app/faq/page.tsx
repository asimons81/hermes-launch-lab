...
export const metadata: Metadata = {
  title: 'FAQ',
  description:
    'Practical answers on independent Hermes Agent consulting: official support status, installation guarantees, preparation, and cancellation policy.',
